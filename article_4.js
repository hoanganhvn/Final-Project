...
//New1-Click on Hidden button
let tableList = document.getElementById("new1-list")
let hiddenbtn = document.getElementById("new1-hidden-icon")
let expandbtn = document.getElementById("new1-expand-icon")
function hiddenTable(){
  tableList.style.display="none";
  hiddenbtn.style.display="none";
  expandbtn.style.display="inline-block"
}
//New1-Click on Expand button
